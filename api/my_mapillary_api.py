"""
Mapillary API Helper Module

Source: https://github.com/kauevestena/my_mappilary_api.git
License: See LICENSE file in the source repository

This module provides a lightweight Python library for accessing the Mapillary API
with GeoDataFrame support.
"""
