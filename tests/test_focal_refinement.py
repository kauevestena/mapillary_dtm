...
def test_refine_focal_geometric_perfect_data():
    ...
    points_3d, points_2d = create_synthetic_correspondences(
        n_points=50, true_focal=true_focal, camera_pose=camera_pose, noise_std=0.0
    )
...
def test_refine_focal_geometric_noisy_data():
    ...
    # Add 1 pixel noise
    points_3d, points_2d = create_synthetic_correspondences(
        n_points=100, true_focal=true_focal, camera_pose=camera_pose, noise_std=1.0
    )
...
def test_refine_focal_geometric_with_distortion():
    ...
    points_3d, points_2d = create_synthetic_correspondences(
        n_points=80, true_focal=true_focal, camera_pose=camera_pose, noise_std=0.5
    )
...
def test_apply_distortion_brown_conrady():
    ...
    coeffs = {"k1": -0.2, "k2": 0.05, "k3": 0.01, "p1": 0.001, "p2": -0.001}
